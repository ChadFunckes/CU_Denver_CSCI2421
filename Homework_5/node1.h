...
//
// ***** added reverse list func ******
// node* reverse_list(const node* head)
// PreCondition: head is a pointer to an existing list that is not null.
// PostCondition: Returns a pointer to a new list that is reversed, this functions
//	leaves the original list entact.
//
